...
// Note: the second argument in mapDispatchToProps is the components own props if you need to access them:
const mapDispatchToProps = (dispatch, props) => ({
    startEditExpense: (id, expense) => dispatch(startEditExpense(id, expense)),
    // Just taking the data passed in which is already destructured in the call in the component and passing it through:
